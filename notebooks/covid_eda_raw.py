...
import subprocess
subprocess.run(["wget", "-q", "https://raw.githubusercontent.com/owid/covid-19-data/master/public/data/hospitalizations/covid-hospitalizations.csv", "-O", "/tmp/covid-hospitalizations.csv"], check=True)
